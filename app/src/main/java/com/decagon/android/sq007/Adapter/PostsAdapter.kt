...
class PostsAdapter(var listOfAuthors: List<AuthorsClass>, var clickItem: PostClickListener) :
    RecyclerView.Adapter<PostsAdapter.PostsViewHolder>() {

    var listOfPosts: List<PostsClass> = listOf()
    ...
    fun setList(list: List<PostsClass>) {
        this.listOfPosts = list
        notifyDataSetChanged()
    }
}

/**this is what i used for the item click listener recyclerview */
//clickItem.onClickItem(listOfClientMeasurements[absoluteAdapterPosition], adapterPosition)